...
app.use('/api/ponds/:pondId/water-quality', waterQualityRoutes);
app.use('/api/ponds/:pondId/feed',          feedRoutes);
app.use('/api/ponds/:pondId/growth',        growthRoutes);
app.use('/api/ponds/:pondId/business',      businessRoutes);
